...
Windows 11 IoT Enterprise, version 21H2 is available for Windows IoT Enterprise device makers through an authorized [Windows IoT Distributor Information](../windows-iot-distributors.md) for building new devices. Windows IoT Enterprise is intended for fixed purpose devices with specific allowances and restrictions in the license agreement. For more information, see [Licensing and Usage](/windows/iot/iot-enterprise/commercialization/licensing) or contact an authorized [Windows IoT Distributor Information](../windows-iot-distributors.md) for more guidance.
...
Windows 11 IoT Enterprise is available as an [annual release](/lifecycle/faq/windows#windows-11). Contact your [Windows IoT Distributor](../windows-iot-distributors.md) for more information.
...
Like Windows 10 IoT Enterprise, Windows 11 IoT Enterprise receives monthly quality updates. For more information about servicing related announcements, see [Windows release health hub](https://aka.ms/windowsreleasehealth) and [Servicing and support](/windows/whats-new/windows-11-plan#servicing-and-support).
