...
This article lists new and updated features and content that are of interest to IT Pros for Windows 10 Enterprise LTSC 2015 (LTSB). For a brief description of the LTSC servicing channel, see [Windows IoT Enterprise LTSC](Windows-IoT-Enterprise-LTSC.md).
...
- [New audit subcategories](#new-audit-subcategories)
- [More info added to existing audit events](#more-info-added-to-existing-audit-events)
...
- [Changed the kernel default audit policy](#changed-the-kernel-default-audit-policy)
- [Added a default process SACL to LSASS.exe](#added-a-default-process-sacl-to-lsassexe)
- [Added new fields in the logon event](#new-fields-in-the-sign-in-event)
- [Added new fields in the process creation event](#new-fields-in-the-process-creation-event)
- [Added new Security Account Manager events](#new-security-account-manager-events)
- [Added new BCD events](#new-bcd-events)
- [Added new PNP events](#new-pnp-events)
...
1. **ElevatedToken** String: yes or no  
...
1. **TargetOutboundUserName** String  
