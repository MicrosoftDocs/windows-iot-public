...
- [Added new fields in the sign-in event](#new-fields-in-the-sign-in-event)
...
1. **TargetUserName** String: The account name of the target user.
1. **TargetDomainName** String: The domain of the target user..
1. **TargetLogonId** String: The sign-in ID of the target user.
1. **ParentProcessName** String: The name of the creator process.
1. **ParentProcessId** String: A pointer to the actual parent process if it's different from the creator process.
