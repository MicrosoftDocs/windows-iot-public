...
1. On the left menu, click on **Clipboard**.

1. Turn on **Clipboard history**.

1. Turn on **Sync across devices**. Choose whether or not to automatically sync copied text across your devices.
...
1. Set the Policy CSP, and the Authentication and EnableFastFirstSignIn policies to enable fast sign-in.

1. Sign-in to a shared PC with your account. You'll notice the difference!
...
1. Set the Policy CSP, and the Authentication and EnableWebSignIn policies to enable web sign-in.

1. On the lock screen, select web sign-in under sign-in options.
