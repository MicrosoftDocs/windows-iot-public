...
2. Format the device. From the WinPE command prompt:
    ...
    >[!Note] 
    >The above Diskpart commands don't create a recovery partition. If you need to configure a recovery partition, see [Configure UEFI/GPT-based hard drive partitions](./configure-uefigpt-based-hard-drive-partitions.md).
