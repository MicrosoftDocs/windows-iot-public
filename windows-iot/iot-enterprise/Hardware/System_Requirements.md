...
| TPM<sup>2</sup>                    | TPM 2.0                           | Optional                          |
...
| TPM<sup>2</sup>        | TPM 2.0                       |TPM 2.0                            | Optional                          |
| Secure Boot<sup>3</sup>  | Enabled                       | Optional                          | Optional                          |
...
<sup>1</sup> **Processor:** For more information, see [Windows IoT Enterprise Supported Processors](Processor_Requirements.md).

<sup>2</sup> **TPM:** For more information about the use of a TPM by Windows, see...
...
<sup>3</sup> **Secure Boot:** For more information, see [Secure Boot and Trusted Boot](/windows/security/operating-system-security/system-security/trusted-boot).
