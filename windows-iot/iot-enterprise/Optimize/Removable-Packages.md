...
|✅| **[Microsoft-Windows-3DAudio-HrtfData](Removable-Packages/Microsoft-Windows-3DAudio-HrtfData.md)** </br> 3D Audio Head-related transfer function (HRTF) also known as Spatial Sound. For more information, see [Spatial Sound for App Developers](/windows/win32/coreaudio/spatial-sound). | <!-- x64 --> &nbsp;KB | <!-- arm64 --> 6,171&nbsp;KB |
...
|✅| **[Microsoft-Windows-NetProfilesUX](Removable-Packages/Microsoft-Windows-NetProfilesUX.md)** </br> Network and Sharing Center Control Panel application. | <!-- x64 --> 899&nbsp;KB | <!-- arm64 --> 1,106&nbsp;KB |
